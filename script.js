...
document.addEventListener('DOMContentLoaded', () => {
   ...
   * @param {HTMLElement} field - O campo de input a validar
   * @param {HTMLElement} errorEl - O elemento para exibir a mensagem de erro
   * @param {string} message - Mensagem de erro caso inválido
   ...
   * Valida todos os campos e exibe feedback visual de sucesso ou erro
   */
  contactForm.addEventListener('submit', (e) => {
    ...
    if (!validateField(nome, document.getElementById('nomeError'), 'Por favor, insira seu nome.')) isValid = false;

    if (!validateField(email, document.getElementById('emailError'), 'Por favor, insira seu e-mail.')) {
      isValid = false;
    ...
    if (!validateField(assunto, document.getElementById('assuntoError'), 'Por favor, insira o assunto.')) isValid = false;
    if (!validateField(mensagem, document.getElementById('mensagemError'), 'Por favor, insira sua mensagem.')) isValid = false;
  ...
  // Remove destaque de erro ao digitar no campo
